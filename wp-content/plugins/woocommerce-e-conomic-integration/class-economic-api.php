...
class WCE_API{
	...
	public function sync_orders(){
		...
		if($this->activate_oldordersync == "on"){
			$all_unsynced_orders = $wpdb->get_results("SELECT * FROM ".$wpdb->prefix."posts WHERE ID NOT IN (SELECT order_id FROM wce_orders) AND post_type='shop_order' AND post_status != 'trash' AND post_status != 'wc-failed' AND post_status != 'wc-cancelled'");
