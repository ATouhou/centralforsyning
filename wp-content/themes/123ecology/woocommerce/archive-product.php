	...
	?>
	        ...
	        <?php if ($thumbnail_id) { ?>
		        <div class="shop-image">	
		            ...
		            <?php if ( is_active_sidebar(5) ){?>
		                <img alt="<?php echo $alt; ?>" src="<?php $image = wp_get_attachment_image_src( $thumbnail_id, 'blog-style-1' ); echo $image[0];?>" />
		            <?php }else{ ?>
		            	<img alt="<?php echo $alt; ?>" src="<?php $image = wp_get_attachment_image_src( $thumbnail_id, 'blog-style-2' ); echo $image[0];?>" />
		            <?php }?>
		        </div>
	        <?php }?>
	    <?php }elseif(is_search()){?>
	        <?php if($shop_search_image_raw){?>
		        <div class="shop-image">	
		            <?php if ( is_active_sidebar(5) ){?>
		                <img alt="<?php echo get_post_meta($shop_search_image, '_wp_attachment_image_alt', true); ?>" src="<?php $shop_search_image_ = wp_get_attachment_image_src( $shop_search_image, 'blog-style-1' ); echo $shop_search_image_[0];?>" />
		            <?php }else{ ?>
		            	<img alt="<?php echo get_post_meta($shop_search_image, '_wp_attachment_image_alt', true); ?>" src="<?php $shop_search_image_ = wp_get_attachment_image_src( $shop_search_image, 'blog-style-2' ); echo $shop_search_image_[0];?>" />
		            <?php }?>
		        </div>
	        <?php }?>
	    <?php }elseif(is_tax()){?>
	        <?php if($shop_tag_image_raw){?>
		        <div class="shop-image">	
		            <?php if ( is_active_sidebar(5) ){?>
		                <img alt="<?php echo get_post_meta($shop_tag_image, '_wp_attachment_image_alt', true); ?>" src="<?php $shop_tag_image_ = wp_get_attachment_image_src( $shop_tag_image, 'blog-style-1' ); echo $shop_tag_image_[0];?>" />
		            <?php }else{ ?>
		            	<img alt="<?php echo get_post_meta($shop_tag_image, '_wp_attachment_image_alt', true); ?>" src="<?php $shop_tag_image_ = wp_get_attachment_image_src( $shop_tag_image, 'blog-style-2' ); echo $shop_tag_image_[0];?>" />
		            <?php }?>
		        </div>
	        <?php }?>
        <?php }else{?>
	        ...
	        <div class="shop-image">	
	            ...
	            <?php if ( is_active_sidebar(5) ){?>
	                <img alt="<?php echo $alt; ?>" src="<?php $image = wp_get_attachment_image_src( get_post_thumbnail_id( $shop_page->ID ), 'blog-style-1' ); echo $image[0];?>" />
	            <?php }else{ ?>
	            	<img alt="<?php echo $alt; ?>" src="<?php $image = wp_get_attachment_image_src( get_post_thumbnail_id( $shop_page->ID ), 'blog-style-2' ); echo $image[0];?>" />
	            <?php }?>
	        </div>
	        <?php }?>
        <?php }?>        
