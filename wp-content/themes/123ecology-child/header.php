...
<html <?php language_attributes(); ?>>
  <head>
    ...
    <?php get_template_part('includes/footer-pattern') ?>
...
<div id="header" class="<?php if($theme_style=="boxed"){?>wrap<?php }?>">
			<div class="container">
			  <div class="row-fluid">
			    <div class="span4">
	                    <?php if($custom_logo){?>
...
<div class="span8">
		...
		<div id="meta_off" class="<?php if($theme_style=="boxed"){?>wrap_off<?php }?>">
