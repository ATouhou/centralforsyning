 ...
 */
add_action( 'admin_init', 'custom_theme_options_child', 1 );

/**
 * Build the custom settings & update OptionTree.
 */
function custom_theme_options_child() {
  /**
  ...
  $custom_settings = array( 
    ...
    'settings'        => array(
      ...
      array(
        ...
        'label'       => 'Meta Social Icons',
        'desc'        => 'Enable for displaying social medial icons in meta right container.',
        'std'         => '',
        'type'        => 'checkbox',
        'section'     => 'general_default',
        'rows'        => '',
...
%page_title% - Will display current page title.',
      ...
      array(
        ...
        'desc'        => 'Select one of pattern for footer.',
        'std'         => 'none',
        'type'        => 'select',
      ...
      array(
        ...
        'desc'        => 'Enable for displaying social medial icons in footer left container.',
        'std'         => '',
        'type'        => 'checkbox',
        'section'     => 'footer_options',
        'rows'        => '',
      ...
      array(
        'id'          => 'zoom',
        'label'       => 'Cloud Zoom',
        'desc'        => 'Check for disabling zooming image on product posts.',
        'std'         => '',
        'type'        => 'checkbox',
        ...
        'choices'     => array( 
          array(
            'value'       => 'Disable Zooming Image',
            'label'       => 'Disable Zooming Image',
            'src'         => ''
          )
        ),
      ),
