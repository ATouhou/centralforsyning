<?php global $woocommerce; ?>
										...
										<?php foreach ( $woocommerce->cart->get_cart() as $cart_item_key => $cart_item ) :
											...
											<div class="item clearfix">
												...
												<div class="cart-content">
													...
													<div class="cart-meta">
														<?php echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf('<a href="%s" class="remove" title="%s">remove</a>', esc_url( $woocommerce->cart->get_remove_url( $cart_item_key ) ), __('Remove this item', GETTEXT_DOMAIN_CHILD) ), $cart_item_key );?>
						...
						<?php if (is_user_logged_in()) { ?>
							<div class="header-cart-navi">
								<a href="<?php echo wp_logout_url(home_url()); ?>"><?php _e( 'Logout', GETTEXT_DOMAIN_CHILD ); ?></a> <span class="separator">|</span>
								<a href="<?php echo get_permalink(woocommerce_get_page_id('myaccount')); ?>"><?php _e( 'My Account', GETTEXT_DOMAIN_CHILD ); ?></a>	
							</div>
						<?php } else{ ?>
							<div class="header-cart-navi">
								<a href="#login-modal" role="button" data-toggle="modal"><?php _e( 'Login', GETTEXT_DOMAIN_CHILD ); ?></a> <span class="separator">|</span>
								<a href="#register-modal" role="button" data-toggle="modal"><?php _e( 'Register', GETTEXT_DOMAIN_CHILD ); ?></a>
							</div>
							<!-- login-modal -->
							<div id="login-modal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="<?php _e( 'Login', GETTEXT_DOMAIN_CHILD ); ?>" aria-hidden="true">
								<div class="modal-header">
								<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
								<h3><?php _e( 'Login', GETTEXT_DOMAIN_CHILD ); ?></h3>
								</div>
								<div class="modal-body">
									...
									<form method="post" class="login">
										...
										<p class="form-row">
											...
											<a class="lost_password" href="<?php echo esc_url( wp_lostpassword_url( home_url() ) ); ?>"><?php _e('Lost Password?', GETTEXT_DOMAIN_CHILD); ?></a>
										</p>
									</form>
								</div>
							...
							<div id="register-modal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="<?php _e( 'Register', GETTEXT_DOMAIN_CHILD ); ?>" aria-hidden="true">
								<div class="modal-header">
								<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
								<h3><?php _e( 'Register', GETTEXT_DOMAIN_CHILD ); ?></h3>
								</div>
								<div class="modal-body">
									<?php echo woocommerce_show_messages1(); ?>	
									<form method="post" class="register">
										...
										<?php endif; ?>
											...
											<label for="reg_email"><?php _e('Email', GETTEXT_DOMAIN_CHILD); ?> <span class="required">*</span></label>
										...
										<p class="form-row form-row-last">
											<label for="reg_password2"><?php _e('Re-enter password', GETTEXT_DOMAIN_CHILD); ?> <span class="required">*</span></label>
										...
										<p class="form-row">
											...
											<input type="submit" class="button" name="register" value="<?php _e('Register', GETTEXT_DOMAIN_CHILD); ?>" />
										</p>
