		...
		<?php $gallery_type = get_post_meta($post->ID, 'gallery_type_value', true);?>
						...
						<div class="post">
		                    <?php if ( $videoURL ) {?>
		                        <iframe class="scale-with-grid shadow-s3" width="870" height="489" src="<?php echo $videoURL ?>?wmode=transparent;showinfo=0" frameborder="0" allowfullscreen></iframe>
						...
						<div class="portfolio-gallery portfolio-4">
							...
							<div id="contaciner">
                                ...
                                $imageArray_gray = wp_get_attachment_image_src($attachment->ID, 'portfolio-post-gray', false);
                                $imageArrayFull = wp_get_attachment_image_src($attachment->ID, 'large', false);?>    
								<a rel="prettyPhoto[pp_gal-1]" title="<?php echo $imageTitle ?>" href="<?php echo $imageArrayFull[0] ?>" class="portfolio-thumbnail bw-effect element 
								<?php if ( $full_width ) {?>
								span2 
								<?php } else {?>
								span3
								<?php }?>
								effect-thumb">
									<img class="bw_Thumbnail" alt="<?php echo $imageTitle ?>" src="<?php echo $imageArray_gray[0] ?>"/>
									<img class="Thumbnail" alt="<?php echo $imageTitle ?>" src="<?php echo $imageArray[0] ?>"/>
