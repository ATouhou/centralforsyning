...
if ( function_exists( 'get_option_tree') ) {
    ...
    /* Footer Options
    ================================================== */
    $footer_social_icons = get_option_tree('footer_social_icons',$theme_options);
    $footer_search = get_option_tree('footer_search',$theme_options);  
}
?>

		<div id="footer">
			<?php if ( is_active_sidebar(2) || is_active_sidebar(9)  ){?>
			<div class="<?php if($theme_style=="boxed"){?>wrap<?php }?> footer-top-line"></div>
			<div class="<?php if($theme_style=="boxed"){?>wrap<?php }?> footer-top">
				<div class="container">
			...
			<?php } ?>
			<div class="<?php if($theme_style=="boxed"){?>wrap<?php }?> footer-bottom">
				<div class="container">
				  <div class="row-fluid">
						<div class="span6 footer-bottom-left">
							...
							<div class="social-media clearfix <?php if($footer_search == "none"){ ?>no-margin<?php } ?>">
								<p><?php _e( 'Social Media:', GETTEXT_DOMAIN_CHILD);?></p>
								<ul>
									...
									<?php if($youtube){?> <li><a class="icon youtube" title="youtube" href="<?php echo $youtube; ?>"><span>youtube</span></a></li> <?php }?>
								</ul>
							</div>
							<?php }?>
							<?php }?>
