...
global $post, $about_meta_boxes;
	...
	foreach($about_meta_boxes as $meta_box) {
        ...
        echo '<p>An example of shortcode - "<strong>twitter</strong>%%<strong>https://twitter.com/lidplussdesign</strong>", available icons: facebook, twitter, twitter-2, yahoo, deviantart, dribbble, dribbble-2, mail, flickr, google, forrest, delicious, digg, skype, youtube, last-fm, linkin, vimeo and tumblr</p>';
