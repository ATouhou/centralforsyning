...
function icon_heading($atts, $content=null){
    ...
    if($icon){
	    $icon_ = "<span class='icon-bg'><span class='img' style='background-image: url(".THEME_ASSETS_CHILD."475-vector-icons/".$icon_size."-white/".$icon_size."Px---".$icon.".png);'></span></span>";
    }
		...
		$out .= '<div class="front_tabs tabbable tabs-left">';
			$out .= '<ul class="nav nav-tabs">';
			    ...
			    if($select_icon == 'none'){
			        ...
			        $icon = "style='background-image: url(".THEME_ASSETS_CHILD."Minicons_Pack_1/".$select_icon.".png);'";
			    }
			    if($i == 1){
				  $out .= ' active';  
			    }
				...
				$out .= '<div class="'.$layout_.' item">';
						if ( $lightbox ) {
							...
							$out .= '<a href="'.$linkURL.'" class="effect-thumb hidden-phone">';
								$out .= '<img class="sd_Thumbnail" alt="'.get_the_title().'" src="'.THEME_ASSETS_CHILD.'img/placeholder-link.png"/>';
								$out .= '<div class="icon link"></div>';
							$out .= '</a>';
							}
                        } elseif ( $videoURL ) {
							...
							$out .= '<a href="'.get_permalink().'" class="effect-thumb hidden-phone">';
								$out .= '<img class="sd_Thumbnail" alt="'.get_the_title().'" src="'.THEME_ASSETS_CHILD.'img/placeholder-camera.png"/>';
								$out .= '<div class="icon eye"></div>';
							$out .= '</a>';
                            }
						...
						$out .= '<a href="'.get_permalink().'" class="effect-thumb hidden-phone">';
							$out .= '<img class="sd_Thumbnail" alt="'.get_the_title().'" src="'.THEME_ASSETS_CHILD.'img/placeholder-page.png"/>';
							$out .= '<div class="icon eye"></div>';
						$out .= '</a>';
                        }
						if ( $linkURL ) {
							...
							<li class="sb-media-skin">
								<div class="mediaholder ">
									...
									<?php if ($type=="product") {?>
										...
										<?php } else{?>
										<img alt="<?php the_title(); ?>" src="<?php echo THEME_ASSETS_CHILD; ?>img/placeholder-465.png"/>
										<?php };?>
									<?php } else{?>
										<?php if ( $linkURL ) {?>
											...
											<img alt="<?php the_title(); ?>" src="<?php $image = wp_get_attachment_image_src( get_post_thumbnail_id( get_the_ID() ), 'showbiz-thumbnail' ); echo $image[0];?>"/>
											<?php } else{?>
											<img alt="<?php the_title(); ?>" src="<?php echo THEME_ASSETS_CHILD; ?>img/placeholder-link-533.png"/>
											<?php };?>
										<?php } elseif ( $videoURL ) {?>
											<?php if(has_post_thumbnail()) {?>
											<img alt="<?php the_title(); ?>" src="<?php $image = wp_get_attachment_image_src( get_post_thumbnail_id( get_the_ID() ), 'showbiz-thumbnail' ); echo $image[0];?>"/>
											<?php } else{?>
											<img alt="<?php the_title(); ?>" src="<?php echo THEME_ASSETS_CHILD; ?>img/placeholder-camera-533.png"/>
											<?php };?>
										<?php } elseif ( (function_exists('has_post_thumbnail')) && (has_post_thumbnail()) ) {?>
										<img alt="<?php the_title(); ?>" src="<?php $image = wp_get_attachment_image_src( get_post_thumbnail_id( get_the_ID() ), 'showbiz-thumbnail' ); echo $image[0];?>"/>
										<?php } else{?>
										<img alt="<?php the_title(); ?>" src="<?php echo THEME_ASSETS_CHILD; ?>img/placeholder-page-533.png"/>
										<?php };?>
									<?php };?>
									</div>
								</div>
							...
							<li class="sb-showcase-skin">
										...
										<div class="mediaholder ">
											...
											<?php if ($type=="product") {?>
												...
												<?php } else{?>
												<img alt="<?php the_title(); ?>" src="<?php echo THEME_ASSETS_CHILD; ?>img/placeholder-321.png"/>
												<?php };?>
											<?php } else{?>
												<?php if ( $linkURL ) {?>
													<?php if(has_post_thumbnail()) {?>
													<img alt="<?php the_title(); ?>" src="<?php $image = wp_get_attachment_image_src( get_post_thumbnail_id( get_the_ID() ), 'widget-thumbnail' ); echo $image[0];?>"/>
													<?php } else{?>
													<img alt="<?php the_title(); ?>" src="<?php echo THEME_ASSETS_CHILD; ?>img/placeholder-link.png"/>
													<?php };?>
												<?php } elseif ( $videoURL ) {?>
													<?php if(has_post_thumbnail()) {?>
													<img alt="<?php the_title(); ?>" src="<?php $image = wp_get_attachment_image_src( get_post_thumbnail_id( get_the_ID() ), 'widget-thumbnail' ); echo $image[0];?>"/>
													<?php } else{?>
													<img alt="<?php the_title(); ?>" src="<?php echo THEME_ASSETS_CHILD; ?>img/placeholder-camera.png"/>
													<?php };?>
												<?php } elseif ( (function_exists('has_post_thumbnail')) && (has_post_thumbnail()) ) {?>
												<img alt="<?php the_title(); ?>" src="<?php $image = wp_get_attachment_image_src( get_post_thumbnail_id( get_the_ID() ), 'widget-thumbnail' ); echo $image[0];?>"/>
												<?php } else{?>
												<img alt="<?php the_title(); ?>" src="<?php echo THEME_ASSETS_CHILD; ?>img/placeholder-page.png"/>
												<?php };?>
											<?php };?>
											</div>
												...
												<div class="heightadjuster table">
													...
													<div class="table-cell onethird <?php if(!has_post_thumbnail()) {?>placeholder-img<?php };?>">	
														<?php if ( $linkURL ) {?>
															...
															<?php } else{?>
															<img alt="<?php the_title(); ?>" src="<?php echo THEME_ASSETS_CHILD; ?>img/placeholder-link-533.png" style="width: 100%"/>
															<?php };?>
														<?php } elseif ( $videoURL ) {?>
															<?php if(has_post_thumbnail()) {?>
															<img alt="<?php the_title(); ?>" src="<?php $image = wp_get_attachment_image_src( get_post_thumbnail_id( get_the_ID() ), 'showbiz-thumbnail' ); echo $image[0];?>" style="width: 100%"/>
															<?php } else{?>
															<img alt="<?php the_title(); ?>" src="<?php echo THEME_ASSETS_CHILD; ?>img/placeholder-camera-533.png" style="width: 100%"/>
															<?php };?>
														<?php } elseif ( (function_exists('has_post_thumbnail')) && (has_post_thumbnail()) ) {?>
														<img alt="<?php the_title(); ?>" src="<?php $image = wp_get_attachment_image_src( get_post_thumbnail_id( get_the_ID() ), 'showbiz-thumbnail' ); echo $image[0];?>" style="width: 100%"/>
														<?php } else{?>
															<?php if ($type=="product") {?>
															<img alt="<?php the_title(); ?>" src="<?php echo THEME_ASSETS_CHILD; ?>img/placeholder-465.png" style="width: 100%"/>
															<?php } else{?>
															<img alt="<?php the_title(); ?>" src="<?php echo THEME_ASSETS_CHILD; ?>img/placeholder-page-533.png" style="width: 100%"/>
															<?php };?>
														<?php };?>
													</div>
