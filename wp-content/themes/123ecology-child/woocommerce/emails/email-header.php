...
<html>
    ...
    <body leftmargin="0" marginwidth="0" topmargin="0" marginheight="0" offset="0" style="color: black;">
                    	...
                    	<table border="0" cellpadding="0" cellspacing="0" width="600" id="template_container" style="<?php echo $template_container; ?>">
							...
							<?php
								if ( $img = get_option( 'woocommerce_email_header_image' ) ) {
									echo '<tr><p style="margin-top:0;"><img src="' . esc_url( $img ) . '" alt="' . get_bloginfo( 'name' ) . '" style="width:600px"/></p></tr>';
								}
							?>
                        	<tr>
                            	<td align="center" valign="top">
